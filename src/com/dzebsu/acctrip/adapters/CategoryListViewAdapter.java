...
public class CategoryListViewAdapter extends ArrayAdapter<Category> {
	...
	private List<Category> objectsInit;
	private final Context context;
	public CategoryListViewAdapter(Context context, List<Category> objects) {
	...
	public long getCategoryByIdInList(long id){
...
*/		 
	 ...
	 private class CategoryFilter extends Filter {
	        ...
	        protected void publishResults(CharSequence constraint,
	            ...
	            objects = (ArrayList<Category>) results.values;
